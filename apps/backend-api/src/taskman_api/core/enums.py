...
class TaskStatus(str, Enum):
    ...
    NEW = "new"
    READY = "ready"
    ACTIVE = "active"  # Task is assigned and active (before in_progress)
...
class ProjectStatus(str, Enum):
    ...
    """
    NEW = "new"              # Project created
    PENDING = "pending"      # Awaiting approval/resources (requires pending_reason)
    ASSIGNED = "assigned"    # Assigned to owner (requires owner)
    ACTIVE = "active"        # Project is active (requires owner)
    IN_PROGRESS = "in_progress"  # Work actively underway (requires owner)
    PAUSED = "paused"  # Project temporarily suspended
    BLOCKED = "blocked"      # Blocked by external dependency (requires blocked_reason)
    COMPLETED = "completed"  # Project finished successfully
    CLOSED = "closed"  # Project archived/closed
...
class SprintStatus(str, Enum):
    ...
    new -> pending -> assigned -> active -> in_progress -> blocked -> completed/cancelled
    """
    NEW = "new"  # Sprint created
    PLANNING = "planning"  # Sprint in planning phase
    PENDING = "pending"      # Awaiting resources (requires pending_reason)
    ASSIGNED = "assigned"    # Sprint assigned to team
    ACTIVE = "active"        # Sprint is in progress
    IN_PROGRESS = "in_progress"  # Sprint work actively underway
    BLOCKED = "blocked"      # Sprint blocked (requires blocked_reason)
    COMPLETED = "completed"  # Sprint finished successfully
    CLOSED = "closed"  # Sprint archived/closed
    CANCELLED = "cancelled"  # Sprint was cancelled
...
class PhaseStatus(str, Enum):
    ...
    IN_PROGRESS = "in_progress"  # Phase is currently active
    COMPLETED = "completed"      # Phase is finished
    SKIPPED = "skipped"          # Phase was intentionally skipped
    BLOCKED = "blocked"  # Phase is blocked by external dependency
...
class ActionListStatus(str, Enum):
    ...
    ACTIVE = "active"  # Action list is active
    ARCHIVED = "archived"  # Action list is archived


class Shape(str, Enum):
    """ContextForge geometry shapes for task visualization."""
    TRIANGLE = "triangle"
    SQUARE = "square"
    PENTAGON = "pentagon"
    HEXAGON = "hexagon"
...
class Stage(str, Enum):
    """ContextForge development stages."""
