/**
 * Task MCP Tools Validation - Pure MCP, No Backend Client Import
 */
...
console.log("╔═══════════════════════════════════════════════════════════╗");
console.log("║       Task MCP Tools - Pure MCP Validation               ║");
console.log("╚═══════════════════════════════════════════════════════════╝\n");
...
async function validate() {
  try {
    ...
    // Note: task_bulk_assign_sprint requires sprint creation, skipping for pure MCP test
    console.log("⏭️  Skipping task_bulk_assign_sprint (requires sprint setup)\n");
