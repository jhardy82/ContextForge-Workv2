---
applyTo: "**/*.sql, sql server*, mssql*, dba*, database admin*, backup database*, restore database*"
description: "Instructions for customizing GitHub Copilot behavior for MS-SQL DBA tasks"
version: "1.0"
---
