...
| 3 | **Dimensional** | Scope breadth? Technical depth? |
| 4 | **Situational** | Constraints? Opportunities? |
| 5 | **Resource** | Time? Skills? Tools? Budget? |
| 6 | **Narrative** | User journey? Business case? |
| 7 | **Recursive** | Feedback loops? Learning capture? |
| 8 | **Sacred Geometry** | Circle? Triangle? Spiral? Golden Ratio? Fractal? |
| 9 | **Computational** | Algorithms? Data models? Performance? |
| 10 | **Emergent** | Novel outcomes? Innovation potential? |
| 11 | **Temporal** | Timeline? Deadlines? Sequencing? |
| 12 | **Spatial** | Distribution? Deployment topology? |
| 13 | **Holistic** | Synthesis? Coherence? Resonance? |
